#!/usr/bin/env python3
"""
Core scheduler – core assets, poll every 15 min.
...
Loop:
  1) For each asset in core_assets():
  ...
  3) Sleep 15 min (align with 15min bar cadence, avoid wasted API calls)
...
def main():
    ...
    print(f"Scheduler (core): poll every 15 min, canonical compute → compute.db")
